...
1. Bản ghi dự án được tạo với trạng thái = "Đang chạy", đủ tên, mốc thời gian và người phụ trách.
...
3. Quản lý nhập tên dự án, mô tả, ngày bắt đầu, ngày kết thúc và chọn người phụ trách.
...
## Alternative Courses
- **UC-PRJ-01.AC.1** — Tại bước 3, nếu quản lý chọn nhiều người phụ trách, hệ thống lưu danh sách người phụ trách và tiếp tục bước 4. *(chờ chốt — Notes TBD-1)*
...
2. Quản lý là người duy nhất tạo dự án (chưa có phân quyền cứng phía máy chủ).

## Notes and Issues
- **[TBD-1]** Người phụ trách là 1 hay nhiều người? | Owner: Hoàng | Due: trước Sprint Planning
- **[TBD-2]** Có sinh mã dự án tự động (PRJ-2026-001…) không? | Owner: BA | Due: khi thiết kế dữ liệu
